...
class TestSimpleNc(unittest.TestCase):
    ...
    def get_uri(self,bounds=Polygon(((0,0),(10,0),(10,15),(0,15))),rng=[datetime.datetime(2007,10,1),datetime.datetime(2007,10,3)],res=5,constant=5,nlevels=1,path=None):
        """
    ...
    def setUp(self):
        self.singleLayer = self.get_uri(bounds=Polygon(((0,0),(20,0),(20,20),(0,20))),rng=[datetime.datetime(2007,1,1),datetime.datetime(2007,1,10)],res=10)
    ...
    def _access(self,uri,polygons,temporal,dissolve,clip,levels,subdivide,subres):
        ...
        VAR = 'Prcp'
        kwds = {
            'rowbnds_name': 'latitude', 
            'colbnds_name': 'longitude',
